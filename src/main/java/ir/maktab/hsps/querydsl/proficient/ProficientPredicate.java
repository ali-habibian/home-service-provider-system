...
public class ProficientPredicate {
    private SearchCriteria criteria;
    private final Utility utility;

    public ProficientPredicate(final SearchCriteria criteria) {
        this.criteria = criteria;
        this.utility = new Utility();
    }

    public BooleanExpression getPredicate() {
        final PathBuilder<Proficient> entityPath = new PathBuilder<>(Proficient.class, "proficient");
